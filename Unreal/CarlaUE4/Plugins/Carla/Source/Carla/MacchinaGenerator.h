...
#include "MacchinaGenerator.generated.h"
...
class CARLA_API AMacchinaCityMapGenerator : public ACityMapMeshHolder
{
    GENERATED_BODY()
...
public:
    ...
    AMacchinaCityMapGenerator(const FObjectInitializer& ObjectInitializer);
    
    ~AMacchinaCityMapGenerator();
...
public:
    ...
    void GenerateScene(const std::string& scene);


    void GenerateMacchina();
